package net.letattung.redefer.rdf2html;
...
import net.letattung.redefer.util.URIResolverImpl;
...
public class RDF2HTMLServlet extends HttpServlet
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8752477769771687054L;
...
//    	((ServletRequest) response).setCharacterEncoding("UTF-8");
        ...
        try
        {
            ...
            if (input == null)
                input = request.getParameter("rdf");
            ...
            if (mode!=null)
            {
            	...
            	if (mode.equals("snippet") || mode.equals("tattung"))
